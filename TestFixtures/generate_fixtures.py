...
Regenerating always changes the file bytes: the generators randomize the master
seed, IV, and KDF salt (pykeepass itself would reuse its blank template's fixed
values), and pykeepass mints fresh UUIDs and timestamps. Only the decoded
content is deterministic, and that is all the tests assert.
