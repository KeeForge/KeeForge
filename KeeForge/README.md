...
- `Models/README.md` — parser, crypto, and persisted models
- `Services/README.md` — storage, cloud sync, device integration, Keychain, App Group
- `ViewModels/README.md` — observable app state
...
- AutoFill handoff: the main app and extension share models plus selected services through `project.yml`, `SharedVaultStore`, App Group defaults, cached database copies, and Keychain entries.
