...
- `DatabaseCreationView.swift` owns local and Dropbox database creation, including master-key input, key-file selection, destination choice, and handoff to Files export or Dropbox folder picking.
