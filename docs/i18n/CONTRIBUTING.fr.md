...
4. Ajoutez sous `## Unreleased` dans [`CHANGELOG.md`](../../CHANGELOG.md) les notes de fonctionnalités et de correctifs destinées aux utilisateurs de toutes les plateformes.
