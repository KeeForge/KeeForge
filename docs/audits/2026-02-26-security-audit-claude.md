...
| `KeeForge/Services/Security/KeychainService.swift` | 115 | Reviewed |
| `KeeForge/Services/Security/BiometricService.swift` | 40 | Reviewed |
| `KeeForge/Services/AppSupport/ClipboardService.swift` | 10 | Reviewed |
| `KeeForge/Services/Persistence/SharedVaultStore.swift` | 41 | Reviewed |
| `KeeForge/Services/Security/ScreenProtectionService.swift` | 76 | Reviewed |
| `KeeForge/Services/AppSupport/FaviconService.swift` | 156 | Reviewed |
| `KeeForge/Services/AppSupport/SettingsService.swift` | 96 | Reviewed |
| `KeeForge/Services/Persistence/DocumentPickerService.swift` | 15 | Reviewed |
| `KeeForge/Services/AutoFill/CredentialMatcher.swift` | 42 | Reviewed |
| `KeeForge/Services/AppSupport/HapticService.swift` | 12 | Reviewed |
