...
- [ ] **10. Cut one RC and produce all three artifacts.** `rc/1.16.0-b48` at `a48d6b1` is the immutable candidate. Xcode Cloud delivered both processed App Store builds; remaining gates, exact direct artifact/staging, and acceptance evidence stay open.
