...
- [ ] **10. Cut one RC and produce all three artifacts.** Immutable `rc/1.16.0-b48` at `a48d6b1` was rejected and never distributed: its Xcode Cloud creation failures were reproduced, and the green iOS 18 GitHub Actions verdict hid canonical XCTest UI failures. A b49 replacement is pending and has not been cut; no b49 artifact or gate is accepted. The release skill and candidate manifest record the required controls for the next candidate.
