...
- Add, rename, edit, and remove an entry's custom fields in the entry editor (#107). Protected fields stay protected, including after a rename, and show hidden until revealed. Fields you add are not protected.
