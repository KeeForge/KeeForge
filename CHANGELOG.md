...
- The read-only badge in a database's toolbar is no longer a second lock icon beside the Lock button. It is now a struck-through pencil, sized like the buttons around it, and tapping it says why editing is off.
